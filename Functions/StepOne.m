function Output = Pro_Gra_Nu(L,g,X,S,lambda,t0,iter)
%Step One of R2LMTL, train different metric while fixed g and S 
...
while(1)
    ...
    Gra_f = 2*Lyk*Gra_f;
    %Now we need to use line search to find the step length
    tk = t0;%Initilize the step length
    %It seems line search is the main reason to make it slow, we will get
    %rid of line search here
